...
export default function Contact() {
  ...
  emailjs
    .send(
      "service_2o4pmzh", // e.g., service_123abc
      "template_17xetwt", // e.g., template_xyz456
      templateParams,
      "Sedh6kwb6oJAdw4Bl"   // e.g., a1b2C3D4E5F6g7H8
    )
    .then((response) => {
  ...
  return (
    ...
    //         <div className="space-y-6 px-2 flex flex-wrap justify-start ">
    ...
    //               <p className="text-gray-600">+91 7367802251</p>
    //             </div>
    //           </div>
    ...
    <section id="contact" className="py-20 bg-white">
      <div className="container  ">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-4 md:px-4 lg:px-20 ">
          <div className="   md:w-1/2 px-4  ">
            <h3 className="text-xl font-bold mb-6 text-gray-800  ">
              Contact Information
            </h3>
            ...
            <div className="space-y-6 px-2 sm:px-4 ">
              <div className="flex items-start gap-3 sm:gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800 sm:text-base">Email</h4>
                  <p className="text-gray-600">
                    khushbookumari18082004@gmail.com
                  </p>
                </div>
